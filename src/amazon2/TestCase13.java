...
//Test Case: Search disinfectant spray in amazon website and select Lysol brand product
public class TestCase13 {
    public static void main(String[] args) throws InterruptedException {
        ...
        //select Lysol disinfectant spray
        driver.findElement(By.xpath("//span[contains(text(),'Lysol Disinfectant Spray, Crisp Linen, 38oz (2X19o')]")).click();
